               ...
               <div class="card card-stats card-round">
                  ...
                  <!--
                     <div class="row align-items-center">
                        ...
                        -->
                        <div class="container">
                        <a  href="<?php echo base_url(); ?>Adscheck/create/" style="float: right;margin-top: 5px;color: #e72c30;font:8px"><img width=20 height=20 src="<?php echo base_url()?>/assets/img/plus.png"></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($ads as $value){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if($this->session->userdata('user_role')=='Administrator'){?>
                                                            <td>
                                                                <a href="<?=site_url('Adscheck/edit/'.$value->id)?>"><i class="fas fa-edit" style="color:#e72c30"></i></a>
                        										| <a  href="<?php echo base_url(); ?>Adscheck/delete/<?php echo $value->id?>" style="color:#e72c30"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                            <?php } ?>
                                                        </tr>
                                                        <?php } ?>
