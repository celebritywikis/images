               ...
               <div class="card card-stats card-round">
                  <div class="card-body">
                     <div class="row align-items-center">
					    ...
					    <form action="<?= base_url('Articlecheck/fileupdate/'.$file_id) ?>" name="addForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					        <div class="field">
					       ...
					       <div class="col col-stats ml-3 ml-sm-0">
					                <button type="button" class=" btn btn-primary" style="margin-left: -17px !important" onClick="addform()">Update Image</button>
					        </div>
					        <br>
					        <div class="col col-stats ml-3 ml-sm-0">
