               ...
               <div class="card card-stats card-round">
                  ...
                  <!--
                     <div class="row align-items-center">
                        ...
                        -->
                        <div class="container">
                        <a  href="<?php echo base_url(); ?>Userscheck/create/" style="float: right;margin-top: 5px;color: #e72c30;font:8px"><img width=20 height=20 src="<?php echo base_url()?>/assets/img/plus.png"></a>
                                                    ...
                                                    foreach ($Users as $value){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?=site_url('Userscheck/edit/'.$value->id)?>"><i class="fas fa-edit" style="color:#e72c30"></i></a>
                        										| <a  href="<?php echo base_url(); ?>Userscheck/delete/<?php echo $value->id?>" style="color:#e72c30"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                            <?php } ?>
                                                        </tr>
                                                        <?php } ?>
