<div class="main-panel">
   <div class="content">
    ...
    <form action="<?= base_url('Userscheck/update/'.$usersedit->id) ?>" name="editaddform" method="POST">
        <div class="field">
            <label class="label">User Name</label>
            <div class="control">
                <input id="username" name="username" class="input" type="text" value="<?= $usersedit->user_name ?>" placeholder="Add User Name">
            </div>
        </div>
        <div class="field">
            ...
            <div class="control">
               ...
               <input id="useremail" name="useremail" class="input" type="email" value="<?= $usersedit->email_id ?>" placeholder="Add Email Id">
        ...
        <div class="field">
            ...
            <?php if($user==$usersedit->user_role) echo "selected";?>><?php echo $user?></option>
            <?php } ?>
            </select>
            </div>
        </div> 
