...
class Categories extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->languages =$this->Categories_model->languages();
        $this->updatedtime = $this->Categories_model->getIndianTime();
        $this->selectyesno = $this->Categories_model->selectyesno();
    ...
    public function index() {
        $header['title'] = 'Categories List';
        $data['ads'] = $this->Categories_model->get_all();
    ...
    public function create() {
        ...
        $header['title']     = 'Ad Category';
        $data['cities']      = $this->Categories_model->get_all();
    ...
    public function store() {
         ...
         */
        $date = date('Y-m');
        $create_month_folder = './uploads/categories/'.$date.'/';
    ...
    public function edit($id) {
        ...
        $data['adsedit'] = $this->Categories_model->get_by_id($id);
    ...
    public function update($id) 
    {
    	...
    	array(
                ...
                $data['adsedit'] =$details= $this->Categories_model->get_by_id($id);
                $this->form_validation->set_rules($rules);
                ...
                if ($this->form_validation->run() == FALSE) {
                	...
                	if(is_array($get_resized_image_names)){
                		 ...
                		 */
                		if($_FILES['userfile']['name']!=''){
                			$full_file_path = './uploads/categories/'.$details->image_large;
                			unlink($full_file_path);
                			$full_medium_file_path = './uploads/categories/'.$details->image_medium;
                			unlink($full_medium_file_path);
                			$full_thumb_file_path = './uploads/categories/'.$details->image_thumb;
                			unlink($full_thumb_file_path);
                			$full_mobile_file_path = './uploads/categories/'.$details->image_mobile;
